...
class Providers
{
    ...
    {
        return in_array($provider, config('socialite-ui.providers', []));
    }
    ...
    public static function name(Provider|string $provider): string
    {
        ...
        return match ($provider) {
            ...
            static::x(), static::xOAuth2() => 'X',
            static::slack(), static::slackOpenId() => 'Slack',
            static::twitter(), static::twitterOAuth2() => 'Twitter',
    ...
    /**
     * Enable the X OAuth 2.0 provider.
     */
    public static function xOAuth2(): string
    {
        return Provider::XOAuth2->value;
    }
}
